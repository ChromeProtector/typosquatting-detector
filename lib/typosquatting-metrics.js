...
const _metric4 = require('./metrics/3_exact_levenshtein')
const _metric5 = require('./metrics/4_samelook_levenshtein')
...
const _metric9 = require('./metrics/8_transpositions_k_2_levenshtein')
